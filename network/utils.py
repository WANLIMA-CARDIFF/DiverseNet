...
class SimpleSegmentationModel_multi_head(nn.Module):
    def __init__(self, backbone, classifier):
        super(SimpleSegmentationModel_multi_head, self).__init__()
    ...
    def forward(self, x):
        ...
        x1, x2, x3, x4, x5, x6, x7, x8, x9, x10 = self.classifier(features)
        ...
        x6 = F.interpolate(x6, size=input_shape, mode='bilinear', align_corners=False)
        x7 = F.interpolate(x7, size=input_shape, mode='bilinear', align_corners=False)
        x8 = F.interpolate(x8, size=input_shape, mode='bilinear', align_corners=False)
        x9 = F.interpolate(x9, size=input_shape, mode='bilinear', align_corners=False)
        x10 = F.interpolate(x10, size=input_shape, mode='bilinear', align_corners=False)
